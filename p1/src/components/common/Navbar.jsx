...
const Navbar = () => {
  return (
    <div style={{marginTop:"80px"}}>
      <nav className="navbar navbar-expand-lg navbar-light bg-info" id="mainNav">
            <div className="container px-4 px-lg-5">
                ...
                <div className="collapse navbar-collapse" id="navbarResponsive">
                    <ul className="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        {/* <li className="nav-item"><Link className="nav-link px-lg-3 py-3 py-lg-4" to="/test">ID check</Link></li> */}
                    </ul>
                </div>
            </div>
        </nav>
